...
const I18N = {
  fr: {
    ...
    "tool.moving": "Déplacer les points",
    "tool.resize": "Redimensionner la pièce",
    "tool.rotate": "Pivoter la pièce",
    "tool.setting": "Éditer l'id des points d'attache",
    "prompt.jointId": "Nouvel id du point d'attache :",
  ...
  en: {
    ...
    "tab.parts": "Parts",
    "tab.joints": "Joints",
    "tool.moving": "Move points",
    "tool.resize": "Resize part",
    "tool.rotate": "Rotate part",
    "tool.setting": "Edit joint ids",
    "prompt.jointId": "New joint id:",
